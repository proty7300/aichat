export const PROVIDERS = {
  ...
  generalcompute: {
    ...
    models: [
      { id: 'deepseek-v3.2-reasoning', name: 'DeepSeek V3.2 Reasoning', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'deepseek-v3.1-reasoning', name: 'DeepSeek V3.1 Reasoning', modes: ['chat', 'coding', 'reasoning'] },
  ...
  freemodelclaude: {
    ...
    models: [
      { id: 'claude-t0', name: 'Claude-t0', modes: ['chat', 'coding', 'reasoning'] },
    ],
    supportsImages: false,
    supportsImageGen: false,
  },
