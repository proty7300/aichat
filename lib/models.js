export const PROVIDERS = {
  pollinations: {
    ...
    models: [
      ...
      { id: 'google/imagen-4.0-fast', name: 'Imagen 4 Fast (Free)', modes: ['image'] },
      { id: 'ideogram/ideogram-3.0', name: 'Ideogram 3.0 (Free)', modes: ['image'] },
      { id: 'qwen/qwen-image-2.0', name: 'Qwen Image 2.0 (Free)', modes: ['image'] },
    ],
