export const PROVIDERS = {
  pollinations: {
    ...
    envKey: null, // Tidak perlu API key!
    baseUrl: 'https://image.pollinations.ai',
    models: [
      { id: 'flux', name: 'Flux (Free, No Key)', modes: ['image'] },
      { id: 'turbo', name: 'Turbo (Fast, Free)', modes: ['image'] },
      { id: 'flux-realism', name: 'Flux Realism (Free)', modes: ['image'] },
    ],
