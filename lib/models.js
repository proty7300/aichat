export const PROVIDERS = {
  ...
  bai: {
    ...
    models: [
      { id: 'bai-claude-haiku-4.5', apiModel: 'claude-haiku-4.5', name: 'Claude Haiku 4.5', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-gemini-3.1-pro', apiModel: 'gemini-3.1-pro', name: 'Gemini 3.1 Pro', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-gemini-3.5-flash', apiModel: 'gemini-3.5-flash', name: 'Gemini 3.5 Flash', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-gemini-3-flash', apiModel: 'gemini-3-flash', name: 'Gemini 3 Flash', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-gpt-5.4-mini', apiModel: 'gpt-5.4-mini', name: 'GPT-5.4 mini', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-gpt-5-mini', apiModel: 'gpt-5-mini', name: 'GPT-5 mini', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-gpt-5.4-nano', apiModel: 'gpt-5.4-nano', name: 'GPT-5.4 nano', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-gpt-5-nano', apiModel: 'gpt-5-nano', name: 'GPT-5 nano', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-minimax-m3', apiModel: 'minimax-m3', name: 'MiniMax-M3', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-minimax-m2.7', apiModel: 'minimax-m2.7', name: 'MiniMax-M2.7', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-deepseek-v4-pro', apiModel: 'deepseek-v4-pro', name: 'DeepSeek-V4-Pro', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-deepseek-v4-flash', apiModel: 'deepseek-v4-flash', name: 'DeepSeek-V4-Flash', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-deepseek-v3.2', apiModel: 'deepseek-v3.2', name: 'DeepSeek-V3.2', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-kimi-k2.5', apiModel: 'kimi-k2.5', name: 'Kimi-K2.5', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-glm-5.1', apiModel: 'glm-5.1', name: 'GLM-5.1', modes: ['chat', 'coding', 'reasoning'] },
      { id: 'bai-glm-5', apiModel: 'glm-5', name: 'GLM-5', modes: ['chat', 'coding', 'reasoning'] },
    ],
    supportsImages: false,
    supportsImageGen: false,
  },
